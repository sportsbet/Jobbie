...
{
    internal sealed class ScheduleByDescriptionPagedListAppender : IHypermediaAppender<ScheduleByDescriptionPagedList>
    {
        public void Append(ScheduleByDescriptionPagedList resource, IEnumerable<Link> configured)
        {
