...
{
    internal sealed class ScheduleByJobPagedListAppender : IHypermediaAppender<ScheduleByJobPagedList>
    {
        public void Append(ScheduleByJobPagedList resource, IEnumerable<Link> configured)
        {
